...
class CometLogger:
    ...
    def upload_dataset_artifact(self):
        dataset_name = self.data_dict.get('dataset_name', 'yolov5-datasets')
        ...
        artifact = comet_ml.Artifact(name=dataset_name, artifact_type='datasets', metadata=metadata)
    ...
    def download_dataset_artifact(self, artifact_path):
        ...
        if type(metadata_names) == dict:
            ...
            raise "Invalid 'names' field in datasets yaml file. Please use a list or dictionary"
