...
def slice_imag(image, sliceWidth=2200, sliceHeight=1900, image_name=None, object_list=[],
               overlap=0.5, new_box_iou_limit=0.35, figsize=(10, 8), imshow=False, label_names=None):
    """
...
def toYolo(box, imageWidth, imageHeight):
    ...
    return int(box[0]), center_x, center_y, width, height
...
if __name__ == '__main__':
    ...
    bug = {0: '白带野螟', 1: '尺蛾', 2: '稻飞虱', 3: '稻纵卷叶螟', 4: '蝼蛄', 5: '鹿子蛾', 6: '蜜蜂', 7: '苍蝇', 8: '突背斑红蝽',
           9: '小菜蛾', 10: '斜纹夜蛾', 11: '金龟子', 12: '瓜绢螟', 13: '飞蛾', 14: '甲虫', 15: '蜂', 16: '蚂蚁', 17: '蝽',
           18: '粉蝶灯蛾', 19: '螟蛾', 20: '拟步甲', 21: '葡萄透翅蛾', 22: '水龟虫', 23: '铜色丽金龟', 24: '蟋蟀', 25: '蚊子',
           26: '似蛾类', 27: '似甲虫科大类', 28: '似蚁类', 29: '似蝇类', 30: '其他类', 31: '未知1', 32: '磕头虫', 33: '瓢虫',
           34: '蝉', 35: '螳螂', 36: '蟑螂', 37: '細紋黛齒螟_黃野螟', 38: '漏标待分类', 39: '未知4', 40: '未知2', 41: '未知3'}

    # 对滑动窗口对象传送数据
    # sw.inputImage(r'E:\yhl\YOLO\yolov5\滑窗\images\result')
    # sw.inputLabel(r'E:\yhl\YOLO\yolov5\滑窗\images\labels', label_names=bug, coordinates='yolo')
    # sw.showImage(0, figsize=(12, 10))
    # sw.showSliceImage(0, overlap=0.3, new_box_iou_limit=0.4)

    rc = randomCenterCrop((2000, 2000))
    rc.inputImage(r'E:\yhl\YOLO\yolov5\滑窗\images\result')
    rc.inputLabel(r'E:\yhl\YOLO\yolov5\滑窗\images\labels', label_names=bug,coordinates='yolo')
    rc.showCopImage(10, new_box_iou_limit=0.35, )
    for i in range(len(rc.dataSet)):
        rc.saveSubImageAndTxt(i, 'im2', 'la2', new_box_iou_limit=0.5,
                             resize=(1200, 1200))

    # 切分并保存数据集中所有图片，子图保存到‘im'，子图标签保存到’la‘
    # for i in range(len(sw.dataSet)):
    #     sw.saveSubImageAndTxt(i, 'im1', 'la1', overlap=0, new_box_iou_limit=0.5,
    #                           save_all=True, resize=(1200, 1200))
        # sw.saveSubImage(i, 'im', overlap = 0.5, resize=(1200, 1200))
