...
"""
Train a YOLOv5 classifier model on a classification datasets
...
def train(opt, device):
    ...
    LOGGER.info(f'Image sizes {imgsz} train, {imgsz} test\n'
                ...
                f'Starting {opt.model} training on {data} datasets with {nc} classes for {epochs} epochs...\n\n'
                f"{'Epoch':>10}{'GPU_mem':>10}{'train_loss':>12}{f'{val}_loss':>12}{'top1_acc':>12}{'top5_acc':>12}")
    for epoch in range(epochs):  # loop over the datasets multiple times
