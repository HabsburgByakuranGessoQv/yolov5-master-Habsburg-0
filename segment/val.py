...
"""
Validate a trained YOLOv5 segment model on a segment datasets
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128-seg.yaml', help='datasets.yaml path')
